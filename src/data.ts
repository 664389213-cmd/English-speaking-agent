    ...
    scenes: [
      {
        ...
        phases: [
          { name: '1. Breaking the Ice', nameCn: '1. 破冰热身', aiGoal: 'Greet the student and ask what they do in their free time. After they answer with ONE or TWO activities, praise that activity specifically and move forward - do NOT ask for more activities.', userHint: 'Greet back and share 1-2 activities you do after school.' },
          { name: '2. Digging Deeper (Why?)', nameCn: '2. 深入交流 (目的)', aiGoal: 'Ask ONE clear question about WHY they like that specific activity - focus on the purpose/benefit. Accept their explanation, then transition to the next phase. Do NOT ask multiple "why" questions.', userHint: 'Explain why you like the hobby (e.g., to relax, to reduce stress, because it makes you happy).' },
